            ...
            try:
                ...
                if "users" not in tables:
                    ...
                    return {
                        "ok": False,
                        "message":
                            "ساختار دیتابیس بکاپ نامعتبر است."
                    }
...
async def auto_backup_loop(app, config):
    """
    بکاپ خودکار غیرفعال شده است.
    ذخیره‌سازی دائمی توسط Remote Storage
    داخل کانال خصوصی انجام می‌شود.
    """

    print(
        "Auto ZIP backup is disabled. "
        "Remote Storage is being used instead."
    )
